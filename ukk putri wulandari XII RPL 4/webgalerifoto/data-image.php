...
<body>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="box">
                <p><a href="tambah-image.php"> <i class="fa-solid fa-plus"></i>Tambah Data</a></p>
                <table border="1" cellspacing="0" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              <a href="edit-image.php?id=<?php echo $row['image_id'] ?>"><i class="fa-solid fa-pen-to-square"></i></a>  
                              <a href="proses-hapus.php?idp=<?php echo $row['image_id'] ?>" onclick="return confirm('Yakin Ingin Hapus ?')"><i class="fa-solid fa-trash"></i></a>
                           </td>
                        </tr>
                        <?php }}else{ ?>
                             <tr>
